...
export const school = [
  {
    ...
    description: [
      "I completed a program of 51 courses (316 ECTS credits) through a range of disciplines. It wasn't just about coding or circuits. I dove into everything from Machine Learning and Software Engineering to the fundamental mechanics of Computer Architecture and Database Design. The program stretched well beyond traditional computing into electrical engineering with Power Systems and Electromagnetic Fields, plus nuclear technology, robotics, optimization techniques, and dynamic programming. From writing algorithms to understanding how power grids and electromagnetic radiation work.",
